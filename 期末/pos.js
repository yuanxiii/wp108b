const Pos = {
  ...
  <thead>
    <tr>
      ...
      <td>
      <img id="image" src="m1.jpg"alt="飲料照片" >
      </td>
  ...
  Pos.calcPrice = function () {
    ...
    if(a=="紅茶:20"){document.getElementById("image").src = "m1.jpg";}
    if(a=="綠茶:20"){document.getElementById("image").src = "m2.jpg";}
    if(a=="珍珠奶茶:35"){document.getElementById("image").src = "m3.jpg";}
    if(a=="咖啡:25"){document.getElementById("image").src = "m1.jpg";}
